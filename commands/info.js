...
module.exports = {
    ...
    async execute(message) {
      ...
      .addFields(
        { name: `Bot Developer`, value: `${userZebby.username}\#${userZebby.discriminator}`, inline: true },
        { name: `Bot Version`, value: version, inline: true },
        { name: `Discord.JS Version`, value: dependencies["discord.js"], inline: true },
        ...
        { name: `Invite Link`, value: `[Click here](https://discord.com/oauth2/authorize?client_id=${client.user.id}&scope=bot&permissions=268487680)`, inline: true }
      );
